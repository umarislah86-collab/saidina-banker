    ...
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-lg space-y-6">
        ...
        <div className="text-center space-y-1">
          ...
          <div className="text-amber-400 font-semibold tracking-widest text-sm uppercase">
            Banker Companion
          </div>
        </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  {diceMode === 'physical' && (
                    <div className="text-amber-400 text-xs mt-1 font-semibold">✓ Disyorkan</div>
                  )}
                </button>
                <button
        ...
        {step === 2 && (
          <div className="bg-gray-900 rounded-2xl border border-gray-800 p-6 space-y-5">
            <div className="flex items-center gap-3">
              <button onClick={() => setStep(1)} className="text-gray-400 hover:text-white p-1">
                ←
              </button>
