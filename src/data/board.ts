export type SquareType = 'mula' | 'property' | 'tax' | 'chance' | 'jail' | 'denda' | 'go_to_jail';
...
export interface BoardSquare {
  ...
  name: string;
  propertyId?: string;
  amount?: number; // for tax / denda squares
}

export const BOARD: BoardSquare[] = [
  { position: 0,  type: 'mula',     name: 'Mula' },
  { position: 1,  type: 'property', name: 'Kangar',           propertyId: 'kangar' },
  { position: 2,  type: 'property', name: 'Batu Pahat',       propertyId: 'batu_pahat' },
  { position: 3,  type: 'property', name: 'Bekalan Air',      propertyId: 'bekalan_air' },
  { position: 4,  type: 'tax',      name: 'Cukai Pendapatan', amount: 1400 },
  { position: 5,  type: 'property', name: 'Automobil',        propertyId: 'automobil' },
  { position: 6,  type: 'chance',   name: 'Keputusan' },
  ...
  { position: 10, type: 'jail',     name: 'Dalam Penjara' },
  ...
  { position: 14, type: 'chance',   name: 'Keputusan' },
  { position: 15, type: 'property', name: 'Bioteknologi',     propertyId: 'bioteknologi' },
  { position: 16, type: 'chance',   name: 'Keputusan' },
  ...
  { position: 20, type: 'denda',    name: 'Denda',            amount: 400 },
  ...
  { position: 24, type: 'chance',   name: 'Keputusan' },
  { position: 25, type: 'property', name: 'Farmaseutikal',    propertyId: 'farmaseutikal' },
  { position: 26, type: 'chance',   name: 'Keputusan' },
  ...
  { position: 34, type: 'chance',   name: 'Keputusan' },
  { position: 35, type: 'property', name: 'Telekomunikasi',   propertyId: 'telekomunikasi' },
  { position: 36, type: 'tax',      name: 'Cukai Jalan',      amount: 700 },
  { position: 37, type: 'property', name: 'Bekalan Elektrik', propertyId: 'bekalan_elektrik' },
...
export function getSquare(position: number): BoardSquare {
